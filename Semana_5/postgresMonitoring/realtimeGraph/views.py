...
from .models import City, Country, Data, Location, Measurement, Role, State, \
    Station, User
...
def data_analysis(request):
    ...
    for measurement in measurements:
        # Calculate average value for each measurement type within the specified time range
        ...
        # Calculate the highest and lowest values within the time range
        max_value = data_query.aggregate(Max("value"))["value__max"]
        min_value = data_query.aggregate(Min("value"))["value__min"]
